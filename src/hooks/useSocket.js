...
// Lấy URL socket từ API URL (bỏ /api/v1)
const getSocketUrl = () => {
  // Sửa lỗi cú pháp: import.meta.env.VITE_API_BASE_URL
  const apiUrl = import.meta.env.VITE_API_BASE_URL || 'https://smart-school-bus-api.onrender.com/api/v1'
  // Sửa lỗi cú pháp: .replace
