...
// import { Home, Users, Calendar, Phone, Settings, LogOut } from 'lucide-react';
...
//               key={item.to}
//               to={item.to}
//               end={item.to === "/driver"} // chỉ active chính xác khi ở root
//               className={({ isActive }) =>
...
//         <button className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-indigo-600 transition w-full">
